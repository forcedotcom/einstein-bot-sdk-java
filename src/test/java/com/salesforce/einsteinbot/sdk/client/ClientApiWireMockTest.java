...
public class ClientApiWireMockTest {
  ...
  private static final String START_SESSION_URI = "/v5.1.0/bots/" + TEST_BOT_ID + "/sessions";
  private static final String SEND_MESSAGE_URI = "/v5.1.0/sessions/" + SESSION_ID + "/messages";
  ...
  void testVerifyVersionFile() throws Exception {
    ...
    assertEquals("v5_1_0_api_specs.yml", property);
  }
